...
class Bikecomputer extends React.PureComponent {
  render() {
    const speed = `${((this.props.speed || 0) * 60 * 60) / 1000} km/h`;
    return (
      <View style={styles.container}>
        <View style={styles.containerInnerSmall}>
          <View style={styles.displayItem}>
            <Text style={styles.displayItemDescription}>Speed</Text>
            <Text style={styles.displayItemValue}>{speed}</Text>
          </View>
        </View>
        <View style={styles.containerInnerBig}>
          <View style={styles.containerTwoRows}>
            <View style={styles.displayItem}>
              ...
              <Text style={styles.displayItemValue}>{`${(this.props.distance ||
                0) * 1000} km`}</Text>
            </View>
            <View style={styles.displayItem}>
          ...
          <View style={styles.containerTwoRows}>
            ...
            <View style={styles.displayItem}>
              ...
              <Text style={styles.displayItemValue}>{`${(this.props.moveTime ||
                0) / 60}h ${(this.props.moveTime || 0) % 60}min`}</Text>
            </View>
          </View>
          <View style={styles.containerTwoRows}>
            <View style={styles.displayItem}>
